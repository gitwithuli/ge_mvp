...
ActiveRecord::Schema[8.0].define(version: 2025_10_20_184345) do
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.index ["title"], name: "index_listings_on_title_trgm", opclass: :gin_trgm_ops, using: :gin
  ...
  create_table "promotions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["listing_id"], name: "index_promotions_on_listing_id"
  end
  ...
  add_foreign_key "promotions", "listings"
end
